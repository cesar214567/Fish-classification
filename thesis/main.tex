...
%\title{Creación de un pipeline utilizando los modelos de detección y localización de objetos en imágenes para mejorar la escalabilidad en términos de especificidad de especies}
