...
ctypes.CDLL(r'C:\Users\Cesar\Fish-classification\cudnn64_8.dll')
...
def run_cross_validation_create_models(nfolds=10):
    ...
    for train_index, test_index in kf.split(train_data):
        ...
        #test data 
        test_data, test_target, train_id = read_and_normalize_train_data()
        

        results = model.evaluate(test_data, test_target, batch_size=128)
